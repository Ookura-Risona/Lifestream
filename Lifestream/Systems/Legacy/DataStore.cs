...
internal class DataStore
{
    ...
    internal void BuildWorlds(uint dc)
    {
        ...
        DCWorlds = Svc.Data.GetExcelSheet<World>().Where(x => x.DataCenter.Value.RowId != dc && x.IsPublic() && x.DataCenter.Value.Region == Player.Object.HomeWorld.GameData.DataCenter.Value.Region).Select(x => x.Name.ToString()).ToArray();
